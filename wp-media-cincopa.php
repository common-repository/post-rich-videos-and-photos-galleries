...
function the_cincopa_footer()
{
	...
	echo "Videos, Slideshows and Podcasts by Cincopa <a href='http://www.cincopa.com/media-platform/wordpress-plugin.aspx'>Wordpress Plugin</a></p>";
}
...
function notifyGA()
{
	...
	$var_utmp='/media-platform/plugin-install-'.cincopa_plugin_ver();
